...
public class Principal4 {
    ...
    //he cambiado el nombre al metodo para que se interponga con el del nuevo examen
	private static boolean login0(Credenciales cred) {
	...
	private static boolean login(Credenciales cred) {
		...
		/*no encuentro el archivo de texto que debo leer ,pero si declaro un 
		 * file reader para leer el archivo o un file y luego un buffered reader
		 * puedo usar el metodo  readline y con un bucle for recorrerlo y ver si alguno delos valores
		 * es valido
		 */
	...
	public static void exportatleta() {
